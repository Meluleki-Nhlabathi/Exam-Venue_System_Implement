 ...
 */
@WebServlet("/LoadCreateExamServlet")
public class LoadCreateExamServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("modules", myModules);

        request.getRequestDispatcher("Lecture/createExam.jsp")
