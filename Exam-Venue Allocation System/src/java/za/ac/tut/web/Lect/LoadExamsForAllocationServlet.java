...
@WebServlet("/LoadExamsForAllocationServlet")
public class LoadExamsForAllocationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Exam> exams =
            examFacade.findByLecturer(lecturer.getLecturerId());

        request.setAttribute("exams", exams);

        request.getRequestDispatcher("Lecture/allocateVenue.jsp")
