...
@WebServlet("/RemoveModuleServlet")
public class RemoveModuleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // ✅ Only deletes the row for THIS lecturer — other lecturers unaffected
        accessFacade.removeLink(lecturer.getLecturerId(), moduleId);
