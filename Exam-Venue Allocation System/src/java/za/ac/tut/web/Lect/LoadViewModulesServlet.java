 ...
 */
@WebServlet("/LoadViewModulesServlet")
public class LoadViewModulesServlet extends HttpServlet {
 @EJB
 ...
 @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // ✅ Only shows modules THIS lecturer is linked to
        List<Module> modules =
            accessFacade.findModulesByLecturer(lecturer.getLecturerId());

        request.setAttribute("modules", modules);

        request.getRequestDispatcher("Lecture/viewModules.jsp")
